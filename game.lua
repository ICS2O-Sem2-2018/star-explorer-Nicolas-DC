...
local function endGame()
     ...
     composer.gotoScene( "highscores", { tome=800, effect="crossFade" } )
end
...
function scene:create( event )
  ...
  physics.pause() -- Temporaily pause the physics engine

  -- Set up display groups
  backGroup = display.newGroup()  -- Display group for the background image
  sceneGroup:insert( backGroup )  -- insert into the scene's veiw group

  mainGroup = display.newGroup()  -- Display group for the ship, asteroids, lasers, etc.
  sceneGroup:insert( mainGroup )  -- Insert into the scene's veiw group
